	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li data-toggle="modal" data-target="#registerModal"><a> <span
						class="glyphicon glyphicon-user" style="color: #ffffff"></span>Sign
						Up
				</a></li>
				<li id='loginout' data-toggle="modal" data-target="#loginModal"><a><span
