...
<body>
	...
	<div style="padding: 30px;">
		...
		<form action="updel.do?action=update" id="upForm"
			...
			<table id="tcreate" border="1px dashed #EEEEEE">
				<thead>
					<tr>
						<th>제목</th>
						<!-- input type이 text -->
						<td><input name="title" id="title" type="text" value="${review.review_title }"
				...
				<tbody>
					<tr>
						<th>작성자</th>
						<td><input name="writer" id="writer" type="text" value="${review.review_writer }"
							onkeydown="if(event.keyCode==13) fnSave()" readonly
							style="height: auto; width: 50%; color: #010101" /></td>
					</tr>
					<tr>
						<th>기업장점</th>
						...
						<td><textarea name="strong" id="strong" cols="50%" rows="10%"
								style="color: #010101;">${review.review_strong }</textarea></td>
					</tr>
					<tr>
						<th>기업단점</th>
						<!-- input type이 textarea -->
						<td><textarea name="weak" id="weak" cols="50%" rows="10%"
								style="color: #010101;">${review.review_weak }</textarea></td>
					</tr>
					<tr>
						<th>경영진에 바라는점</th>
						<!-- input type이 textarea -->
						<td><textarea id="toCEO" name="toCEO" cols="50%" rows="10%"
								style="color: #010101;">${review.review_toCEO }</textarea></td>
					</tr>
				</tbody>
				<tfoot>
					<th>별점</th>
			...
			<div class="row" align="center">
				<div class="col-md-2">
					<button type="button" id="update" class="btn btn-default" onclick="validateCheck()">수정
					</button>
				</div>
				<div class="col-md-2">
					<button type="button" class="btn btn-danger">
						<a href="control.do">취소</a>
					</button>
				</div>
			</div>
		</form>
